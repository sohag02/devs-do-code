...
export default function PrivacyPage() {
  ...
  return (
    <PolicyLayout
      ...
      description="Your privacy is important to us. This policy outlines how we collect, use, and protect your data."
    >
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="space-y-4 text-white/80">
              <p>
                At Devs Do Code, we take your privacy seriously. This Privacy
                Policy explains how we collect, use, disclose, and safeguard
                your information when you use our services.
              </p>
              <p>
                By using our services, you consent to the data practices
                described in this privacy policy. We may update this policy
                periodically, and we'll notify you of any material changes.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-white/80 mb-6">
              ...
              like to exercise your privacy rights, please contact our privacy
              team.
            </p>
            <a
