...
export default function Hero() {
  return (
    ...
    <div className="w-full transition-colors duration-300 bg-[#f0fff9] dark:bg-[#001a11]">
      {/* Inner div for max-width constraint */}
      <div className="w-full max-w-6xl mx-auto py-16">
      <div className="container px-4 mx-auto pt-8 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            {/* Product Badge */}
            <div className="relative flex h-10 text-gray-500 dark:text-yellow-200/50">
              <svg
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 1241 1996"
                className="relative h-11 -mt-1"
              >
                <g clip-path="url(#a)">
                  <path
                ...
                <defs>
                  <clipPath id="a">
                    <path fill="#fff" d="M0 0h1241v1996H0z"></path>
                  </clipPath>
                </defs>
              </svg>
              <div className="-mx-1 h-full flex flex-col justify-between items-center font-sans py-0.5">
                <span className="font-bold text-current text-[10px]">
                  Product of the Day
                </span>
            ...
            <div className="space-y-6">
              <h1 className="text-5xl font-bold tracking-tight">
                Chat with the top LLMs
              </h1>
              <p className="text-xl max-w-[600px]">
                Chat with Best llms: Mixtral, Llama-3, Claude-3, Gemini 1.5 Pro,
                Perplexity, GPT-5, SD3 all at one place.
              </p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2 text-emerald-500">
                  <span className="text-lg font-medium">20% off</span>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-10 h-10 rounded-full border-2 border-background bg-emerald-100 dark:bg-emerald-900 flex items-center justify-center">
                    <span className="text-sm font-medium text-emerald-700 dark:text-emerald-300">
                      99+
                    </span>
                  </div>
                </div>
                <div className="flex flex-col space-x-4 justify-start">
                  {/* Stars */}
          ...
          <div className="relative">
            <div className="rounded-lg overflow-hidden shadow-2xl">
              <video src="/hero.mp4" controls autoPlay></video>
            </div>
          </div>
        </div>
      </div>
